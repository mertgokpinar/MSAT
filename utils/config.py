...
class Config:
    ...
    def __init__(self, cfg_id, tmp=False, create_dirs=False):
        ...
        # results dirs
        cfg_root_dir = '/tmp/msat' if tmp else self.results_root_dir
        ...
        shutil.copy2(os.path.join('cfg/radiate/10_sample',cfg_id+'.yml'), os.path.join(self.log_dir,'config.yml')) #TODO: fix path
